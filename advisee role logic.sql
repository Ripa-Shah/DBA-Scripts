...
in('student','admiss_admin','admiss_coun','admiss_officer','advisor','advisor_admin',
'alumni','candidate','dev_officer','employ_applcnt','faculty','finaid_admin','general_ledger',
'guest','staff','staff_admin','student','student_admin'))

--select * from TW_GROUP;
